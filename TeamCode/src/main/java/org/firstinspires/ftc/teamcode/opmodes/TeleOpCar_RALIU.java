...
@Config
@com.qualcomm.robotcore.eventloop.opmode.TeleOp(name = "TeleOpCar_RALIU💨", group = "OpModes")
public class TeleOpCar_RALIU extends CommandOpMode {
    ...
    public void initialize() {
        ...
        car.driveTrain.initializeRaliu();
        car.arm.initialize();
...
//                );
    ...
    public void run() {
        ...
        car.bulkRead();
        car.driveTrain.loopRaliu(gamepad1.left_stick_y, gamepad1.right_stick_x);
        car.arm.loop();
